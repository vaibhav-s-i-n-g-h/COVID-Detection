...
def predict_covid_and_plot(  X_test_batch , class_of_interest=1):
    new_image = X_test_batch[0]
    img=new_image
    # check prediction
    model_loaded = load_model('model_2.h5')
    model=model_loaded
    ...
    plt.savefig('gradcam.png')                         ###########################name of second image
    return pred[0][0]

def predict_normal_and_pneumonia(  X_test_batch , class_of_interest=1):
    new_image = X_test_batch[0]
    img=new_image
    # check prediction
